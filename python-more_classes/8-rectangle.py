...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Return the rectangle with the larger area or rect_2 if equal.
        ...
        Returns:
            Rectangle: The rectangle with the larger area, or rect_2 if equal.

        Raises:
            TypeError: If rect_1 or rect_2 is not an instance of Rectangle.
        """
        if not isinstance(rect_1, Rectangle) or not isinstance(rect_2, Rectangle):
            raise TypeError("{0} must be an instance of Rectangle".format(
