...
formal (via __str__ and __repr__) use cases, and validates width and height
values to ensure they are non-negative integers. Additionally, it includes
a custom destructor method to print a message upon an instance's deletion.
"""
...
class Rectangle:
    ...
    def __del__(self):
        """Print a message upon the rectangle's deletion."""
        print("Bye rectangle...")
